        ...
        <form action="" method="POST">
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="custome_contact" value="<?php echo $customer_contact; ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="custome_email" value="<?php echo $customer_email; ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea type="text" name="custome_address" cols="30" rows="5"> <?php echo $customer_address; ?> </textarea>
                    </td>
                </tr>
